...
class Contacts(models.Model):
    ...
    latitude = models.CharField(max_length=1000, verbose_name="Ish vaqti")
    longitude = models.TextField(verbose_name="Harita Iframini kiriting")
    logo = models.ImageField(upload_to="logo/photos", verbose_name="Logotip")
    iframe = models.TextField(verbose_name="Xarita iframeni kiriting")
    class Meta:
        verbose_name = "Aloqa"
